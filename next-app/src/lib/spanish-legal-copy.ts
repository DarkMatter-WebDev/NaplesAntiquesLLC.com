...
export const SPANISH_LEGAL_COPY: Record<LegalPageKey, SpanishLegalPageCopy> = {
    ...
    sections: [
      {
        ...
        bullets: [
          ...
          'Información de participación en subastas o de vendedores si habilitamos esas funciones por separado o la recopilamos mediante un proceso de registro relacionado.',
      ...
      },
      {
        ...
        bullets: [
          ...
          'Respaldar procesos de subastas, vendedores o mercado si esos servicios se ofrecen por separado.',
  ...
  terms: {
    ...
    updated: UPDATED,
    intro: [
      'Estos Términos de Servicio se aplican a naplesestatejewelry.co y a los servicios relacionados proporcionados por Naples Estate Jewelry, operada por Naples Antiques LLC. Al utilizar el sitio, crear una cuenta, enviar información o hacer un pedido, acepta estos términos.',
    ],
    sections: [
      {
        title: 'Nuestro Sitio Web y Servicios',
        body: ['Operamos un sitio web de pequeña empresa para servicios de compra de joyería de patrimonio y antigüedades, consultas de productos, cuentas de clientes, carritos guardados, solicitudes de pedidos en línea y publicaciones seleccionadas de comercio electrónico. Las funciones de subastas, mercado y vendedores pueden ser informativas, limitadas o habilitarse por separado.'],
      },
      {
      ...
      },
      {
        ...
        body: [
          ...
          'Si se habilitan pagos en línea, el procesamiento puede ser proporcionado por un tercero. Acepta proporcionar información de pago exacta y autoriza los cargos aplicables a compras confirmadas.',
        ],
      },
      {
      ...
      {
        title: 'Subastas, Mercado y Vendedores',
        body: ['Si se habilitan por separado funciones de subastas, mercado o vendedores, pueden aplicarse Términos de Subasta o Términos para Vendedores adicionales. Una puja, publicación de vendedor o envío al mercado solo podrá crear obligaciones vinculantes conforme a las reglas específicas presentadas para esa función.'],
      },
      {
        title: 'Uso Aceptable',
        bullets: [
  ...
  'auction-terms': {
    ...
    updated: UPDATED,
    intro: ['La página actual de Subastas es informativa y de consulta. El sitio no opera actualmente pujas públicas en vivo, salvo que un evento específico o un proceso de registro indique por separado que las pujas están abiertas.'],
    sections: [
      { title: 'Responsabilidades del Postor', body: ['Si se habilitan pujas para una subasta específica, los postores deben leer la descripción del lote, las notas de condición, las fotos, los requisitos de pago, los límites de recogida o envío, la prima del comprador si existe y todas las reglas del evento antes de pujar.'] },
      { title: 'Obligaciones del Postor Ganador', body: ['Una puja ganadora puede crear la obligación vinculante de pagar el artículo, impuestos, tarifas, envío, seguro y cualquier prima del comprador indicada. No completar el pago puede resultar en cancelación, restricción de la cuenta u otros recursos permitidos por la ley.'] },
      { title: 'Pujas Máximas y Errores de Puja', body: ['Si se ofrecen pujas máximas, usted es responsable del importe máximo que introduce. Contáctenos de inmediato si cree que cometió un error. Podemos, sin estar obligados a ello, corregir o cancelar pujas cuando el error sea claro y la corrección resulte justa para la subasta.'] },
      { title: 'Condición y Autenticidad', body: ['Los artículos de subasta suelen ser bienes de patrimonio, antiguos o usados. Los informes de condición son opiniones basadas en la información disponible y no sustituyen su propia revisión. Puede ofrecerse una inspección adicional antes de pujar cuando sea práctico.'] },
      { title: 'Responsabilidades del Vendedor', body: ['Los vendedores deben poseer el título legal o la autorización para vender los artículos y deben revelar problemas de condición conocidos, reparaciones, restricciones de procedencia, gravámenes, reclamaciones o dudas de autenticidad.'] },
      { title: 'Cancelación y Derechos de la Plataforma', body: ['Podemos retirar lotes, rechazar pujas, cancelar ventas, corregir errores, suspender cuentas o cambiar procedimientos cuando sea razonablemente necesario por equidad, seguridad, cumplimiento legal, sospecha de fraude o motivos operativos.'] },
    ],
  },
  'vendor-terms': {
    title: 'Términos para Vendedores',
    updated: UPDATED,
    intro: ['El sitio actual no ofrece registro público de cuentas de vendedor. Estos términos sirven como base para cualquier relación con vendedores, consignadores, mercados o publicaciones que aprobemos por escrito o mediante un futuro proceso de registro.'],
    sections: [
      { title: 'Requisitos de Publicación', body: ['Los vendedores deben proporcionar descripciones y fotos exactas, información de propiedad, detalles de condición, información sobre metales o gemas cuando se conozca y cualquier documentación requerida. Podemos editar, rechazar o eliminar publicaciones incompletas, engañosas, riesgosas o incompatibles con nuestra marca.'] },
      { title: 'Artículos Prohibidos', body: ['Los vendedores no pueden publicar bienes robados, falsificados, obtenidos ilegalmente, materiales restringidos, artículos inseguros, bienes que infrinjan derechos de propiedad intelectual o artículos que no estén autorizados a vender.'] },
      { title: 'Tarifas, Comisiones y Plazos de Pago', body: ['Las tarifas, comisiones, plazos de pago, responsabilidades de envío, gestión de devoluciones, seguro e impuestos deben acordarse por escrito o en los términos aplicables del programa antes de publicar artículos.'] },
      { title: 'Suspensión de Cuenta', body: ['Podemos suspender o terminar la participación de un vendedor por publicaciones inexactas, quejas de clientes, sospecha de fraude, artículos prohibidos, falta de pago, riesgo legal u otra conducta que pueda perjudicar a clientes o al negocio.'] },
      { title: 'Propiedad Intelectual', body: ['Los vendedores conservan la propiedad de sus fotos y descripciones, pero nos autorizan a utilizarlas, editarlas, mostrarlas, archivarlas y promocionarlas para publicaciones, ventas, atención al cliente y fines legales o administrativos.'] },
    ],
  },
};
