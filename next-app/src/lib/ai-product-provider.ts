...
- product_type: classify aggressively when the item form is obvious (Ring, Bracelet, Necklace, Pendant, Charm, Earrings, Brooch, Watch, Coin, Bullion, Loose Diamond, Loose Gemstone, Silverware / Sterling, Estate Lot). Use Charm for a standalone decorative charm intended to hang from a bracelet or necklace; use Pendant for a piece worn as a primary necklace drop. If unclear, use Other or null.
