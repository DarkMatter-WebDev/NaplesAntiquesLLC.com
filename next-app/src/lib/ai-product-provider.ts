...
- length is the shared length/size field. Treat explicitly stated forms such as 24, 24 in, 24 inches, and 24" as the same value. Return one bare canonical numeric string with no unit text (for example, return "24"); never estimate it from appearance.
