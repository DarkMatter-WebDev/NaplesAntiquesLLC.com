...
const DEFAULT_SITE_URL = 'https://naplesestatejewelry.co';

export const SITE_DOMAIN_LABEL = 'naplesestatejewelry.co';
 ...
 * so recipients always have a clickable way back to naplesestatejewelry.co.
 */
