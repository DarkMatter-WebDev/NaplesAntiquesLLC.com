  ...
  return (
    <LegalPolicyPage
      ...
      intro={spanishCopy?.intro ?? [
        'These Terms of Service apply to naplesestatejewelry.com and related services provided by Naples Estate Jewelry, operated by Naples Antiques LLC. By using the website, creating an account, submitting information, or placing an order, you agree to these terms.',
      ]}
      sections={spanishCopy?.sections ?? [
        {
          title: isEs ? 'Nuestro Sitio Web y Servicios' : 'Our Website and Services',
          body: [
            'We operate a small-business website for estate jewelry and antiques buying services, product inquiries, customer accounts, saved carts, online order requests, and curated ecommerce listings.',
          ],
        },
        {
        ...
        },
        {
          ...
          body: [
            ...
            'Online payment processing is provided by a third-party payment processor. You agree to provide accurate payment information and authorize applicable charges for confirmed purchases.',
          ],
        },
        {
