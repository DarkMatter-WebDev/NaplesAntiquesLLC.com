...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      type: 'website',
      url: `https://naplesestatejewelry.co${isEs ? '/es' : ''}/sell`,
        ...
        <section className="mx-auto max-w-[1440px] px-4 py-20 md:px-8">
          ...
          <div className="grid grid-cols-2 gap-6 lg:grid-cols-4">
            {buyCategories.map((c) => (
              ...
              >
                <span className="material-symbols-outlined mb-4 text-[#735c00]" style={{ fontSize: '2.75rem', fontVariationSettings: "'FILL' 0, 'wght' 200" }} aria-hidden="true">
                  {c.icon}
                </span>
