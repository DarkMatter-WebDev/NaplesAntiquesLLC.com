  ...
  return (
    <div className={`shop-filters${isModern ? ' shop-filters-modern' : ''}`} style={{ marginBottom: '1.5rem' }} data-filters-open={filtersOpen ? 'true' : 'false'}>
      ...
      <div className="shop-filter-toggle-row" style={{ display: 'flex', justifyContent: 'center', marginBottom: filtersOpen ? '0.85rem' : '0.5rem' }}>
        ...
        >
          <AppIcon name="filter_list"  aria-hidden="true" style={{ fontSize: '17px' }} />
      ...
      <div id="shop-filter-panel" className={`shop-filter-panel${filtersOpen ? ' is-open' : ''}`}>
        ...
        <div className="shop-search-spot-row">
          <SpotRefreshPill
            ...
            display={formatSpot(spotData?.silverPerTroyOz)}
            containerStyle={silverBadgeStyle}
            labelStyle={silverLabelStyle}
            priceStyle={silverPriceStyle}
          />
          ...
          <SpotRefreshPill
            ...
            display={formatSpot(spotData?.goldPerTroyOz)}
            containerStyle={goldBadgeStyle}
            labelStyle={goldLabelStyle}
            priceStyle={goldPriceStyle}
          />
        </div>
      ...
      <style>{`
        ...
        .shop-clear-filters-top .app-icon {
          font-size: 1rem;
          line-height: 1;
        }
        .shop-clear-filters-top button,
        ...
        .shop-apply-filters-button .app-icon {
          font-size: 1.15rem;
          line-height: 1;
        }
        .shop-price-filter {
