                ...
                <div className="flex items-center justify-between gap-3">
                  ...
                  {state.status === 'checking' && (
                    <span className="flex items-center gap-2 text-xs" role="status" aria-live="polite" style={{ color: 'var(--color-on-surface-variant)' }}>
                      <AppIcon name="sync" className="animate-spin" aria-hidden="true" style={{ color: 'var(--color-primary)', fontSize: '18px' }} />
                      Checking...
                    </span>
                  )}
                </div>
                      ...
                      return (
                        ...
                        >
                          <span className="flex w-full items-start justify-between gap-1">
                            ...
                            {count > 0 && <AppIcon name="chevron_right"  aria-hidden="true" style={{ color: 'var(--color-primary)', fontSize: '17px' }} />}
                          </span>
