...
export default function AdminHeader({
  ...
  const toggleBtn = (
    ...
    >
      <AppIcon name={collapsed ? 'menu' : 'menu_open'}  aria-hidden="true" style={{ fontSize: '1.25rem', lineHeight: 1 }} />
    </button>
  );
  ...
  return (
    ...
    >
      ...
      <AdminNavItem href={`${adminBasePath}/text-deals`} active={active === 'text-deals'}>
        Text Deals
      </AdminNavItem>
