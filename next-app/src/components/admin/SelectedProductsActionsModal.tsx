...
function ActionButton({
  ...
  return (
    ...
    >
      <span className="material-symbols-outlined shrink-0" style={{ ...iconStyle, fontSize: '22px', color: 'var(--color-primary)' }} aria-hidden="true">
        {icon}
      </span>
      ...
      <span className="material-symbols-outlined ml-auto shrink-0" style={{ ...iconStyle, fontSize: '20px', color: 'var(--color-on-surface-variant)' }} aria-hidden="true">
        chevron_right
      </span>
    </button>
  );
