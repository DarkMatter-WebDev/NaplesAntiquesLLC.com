...
- Reciprocal alternate links in BOTH pages' `<head>`:
  ```html
  <link rel="alternate" hreflang="en" href="https://naplesestatejewelry.co/about.html" />
  <link rel="alternate" hreflang="es" href="https://naplesestatejewelry.co/es/about.html" />
  <link rel="alternate" hreflang="x-default" href="https://naplesestatejewelry.co/about.html" />
  ```
...
- **Submit Your Item form**: Spanish contact page uses its own Netlify Form
  (`submit-item-es`) with localized labels and multipart photo uploads.
...
6. **Remaining:** native-speaker review of all ES copy; create a Spanish MailerLite
   ...
   Spanish Netlify form for `/es/contact.html`.
