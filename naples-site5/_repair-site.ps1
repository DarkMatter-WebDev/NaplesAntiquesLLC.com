...
<header class="site-header site-header--light fixed top-0 w-full z-50 bg-[#f9f9f7]/95 border-b border-[#d8d0c2]">
  ...
  <motion.div id="mobile-menu" class="hidden 2xl:hidden border-t border-[#d8d0c2] bg-[#f9f9f7]/98"><motion.div class="flex flex-col px-5 py-4"><a class="$mobileHome" href="index.html">Home</a><a class="$(Get-MobileClass 'about' $active)" href="about.html">About</a><a class="$(Get-MobileClass 'what-we-buy' $active)" href="what-we-buy.html">What We Buy</a><a class="mobile-subitem" href="estate-jewelry.html">Estate Jewelry</a><a class="mobile-subitem" href="gold-services.html">Gold Services</a><a class="mobile-subitem" href="silver-services.html">Silver Services</a><a class="mobile-subitem" href="bullion.html">Bullion</a><a class="$(Get-MobileClass 'process' $active)" href="process.html">Process</a><a class="$(Get-MobileClass 'estate-services' $active)" href="estate-services.html">Estate Services</a><a class="$(Get-MobileClass 'faq' $active)" href="faq.html">FAQ</a>$indexMobileExtras<a class="text-[#735c00] font-label-md py-3" href="tel:2394048505">Call (239) 404-8505</a></div></div>
</header>
"@.Replace('motion.', '')
}
...
$pageActive = @{
  ...
  'process.html' = 'process'; 'gold-services.html' = 'gold-services'
